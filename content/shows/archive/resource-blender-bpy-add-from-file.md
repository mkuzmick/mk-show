# ADD OBJECT FROM FILE IN PY SCRIPT #



## REFERENCE FROM OLDER SCRIPTS ##

Apparently I've done this before, and while the docs seem completely foreign, supposedly I wrote this script a year and a half ago:
```
...
so here's where I am after 15 minutes of trying to refresh my memory (and maybe cleaning all this up a bit with classes):
```
import bpy
import os
