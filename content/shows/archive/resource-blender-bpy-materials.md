...
# BPY MATERIALS
apparently 2.80 introduced some changes that have broken most pre-2018 scripts that add materials and textures.

but here's a snippet to try from [this link](https://blender.stackexchange.com/questions/118646/add-a-texture-to-an-object-using-python-and-blender-2-8):
```
...
#        self.sideTextureSlot = self.sideMaterial.texture_slots.add()
